...
class CustomExpansionPanel {
  ...
  /// used as a child for [CustomExpansionPanelList].
  ...
  /// bool to hide and show arrow icon on the header footer.
  final bool hasIcon;
...
/// normal [CustomExpansionPanelList] widgets,
///  it is the responsibility of the parent
/// widget to rebuild the [CustomExpansionPanelList] with updated values for
/// [CustomExpansionPanel.isExpanded].
/// For [ExpansionPanelList.radio] widgets, the
...
/// a variant of this widget where only one panel is open at a time.
///  * <https://material.io/design/components/lists.html#types>
class CustomExpansionPanelList extends StatefulWidget {
  ...
  ///
  /// For [CustomExpansionPanelList],
  ///  the callback should call [State.setState] when
  ...
  ///
  /// By default, 16px of space is added to
  /// the header vertically (above and below)
  /// during expansion.
  final EdgeInsets expandedHeaderPadding;

  /// Defines color for the divider when
  /// [CustomExpansionPanel.isExpanded] is false.
  ///
...
class _CustomExpansionPanelListState extends State<CustomExpansionPanelList> {
  ...
  void _handlePressed(bool isExpanded, int index) {
    ...
    // !isExpanded is passed because, when
    //_handlePressed, the state of the panel to expand is not yet expanded.
    ...
    for (var index = 0; index < widget.children.length; index += 1) {
      ...
      Widget header = Row(
        children: <Widget>[
          ...
          SizedBox(child: child.hasIcon ? expandIconContainer : null),
        ],
      );
      if (child.canTapOnHeader) {
