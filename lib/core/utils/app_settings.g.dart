...
const AppSettingsSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'passOnboarding': PropertySchema(
      id: 1,
      name: r'passOnboarding',
      type: IsarType.bool,
    ),
...
void _appSettingsSerialize(
  ...
  writer.writeBool(offsets[1], object.passOnboarding);
...
AppSettings _appSettingsDeserialize(
  ...
  final object = AppSettings(
    language:
        _AppSettingslanguageValueEnumMap[reader.readByteOrNull(offsets[0])] ??
            Language.en,
    passOnboarding: reader.readBoolOrNull(offsets[1]) ?? false,
    themeMode:
...
P _appSettingsDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (_AppSettingslanguageValueEnumMap[reader.readByteOrNull(offset)] ??
          Language.en) as P;
    case 1:
...
extension AppSettingsQueryFilter
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterFilterCondition>
      passOnboardingEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'passOnboarding',
        value: value,
      ));
    });
  }
...
extension AppSettingsQuerySortBy
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterSortBy> sortByPassOnboarding() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'passOnboarding', Sort.asc);
    });
  }

  QueryBuilder<AppSettings, AppSettings, QAfterSortBy>
      sortByPassOnboardingDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'passOnboarding', Sort.desc);
    });
  }
...
extension AppSettingsQuerySortThenBy
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterSortBy> thenByPassOnboarding() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'passOnboarding', Sort.asc);
    });
  }
...
extension AppSettingsQueryWhereDistinct
  ...
  QueryBuilder<AppSettings, AppSettings, QDistinct> distinctByPassOnboarding() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'passOnboarding');
    });
  }
...
extension AppSettingsQueryProperty
  ...
  QueryBuilder<AppSettings, Language, QQueryOperations> languageProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'language');
    });
  }

  QueryBuilder<AppSettings, bool, QQueryOperations> passOnboardingProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'passOnboarding');
    });
  }
